"""
GitHub Operation Executor

Specialized executor for all GitHub operations.
"""
...
class GitHubExecutor(BaseExecutor):
    ...
    def can_execute(self, action_type: str) -> bool:
        ...
        try:
            ...
            return action_enum in self.GITHUB_ACTIONS
        except ValueError:
            return False
    ...
    async def execute(
        ...
        try:
            ...
            return ExecutionResult(
                success=False,
                message=f"GitHub execution failed: {str(e)}",
                error=str(e)
            )
